...
public class ThirdStageData : StageData
{
    protected abstract class fsPattern : PatternClass
    {
        protected ThirdStageData stageData;

        public fsPattern(ThirdStageData stage) {stageData = stage;}
    ...
    protected class FadeInPattern : fsPattern
    {
        ...
        public FadeInPattern(ThirdStageData stage) : base(stage) {}
    ...
    protected class StageStartPattern : fsPattern
    {
        ...
        public StageStartPattern(ThirdStageData stage) : base(stage) {}
    ...
    protected class StageEndPattern : fsPattern
    {
        ...
        public StageEndPattern(ThirdStageData stage) : base(stage) {}
